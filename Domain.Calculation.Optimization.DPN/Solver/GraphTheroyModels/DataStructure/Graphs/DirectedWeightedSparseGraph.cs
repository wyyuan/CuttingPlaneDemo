...
namespace DataStructures.Graphs
{
    public class DirectedWeightedSparseGraph<T> : IGraph<T>, IWeightedGraph<T> where T : IComparable<T>
    {
        ...
        /// INSTANCE VARIABLES
        /// </summary>
        private const decimal EMPTY_EDGE_VALUE = decimal.MinValue;
        ...
        /// </summary>
        private decimal _getEdgeWeight(T source, T destination)
        {
        ...
        /// </summary>
        public bool AddEdge(T source, T destination, decimal weight)
        {
        ...
        public bool UpdateEdgeWeight(T source, T destination, decimal weight)
        {
        ...
        /// </summary>
        public virtual decimal GetEdgeWeight(T source, T destination)
        {
        ...
        /// </summary>
        public Dictionary<T, decimal> NeighboursMap(T vertex)
        {
            if (!HasVertex(vertex))
                return null;

            var neighbors = _adjacencyList[vertex];
            var map = new Dictionary<T, decimal>(neighbors.Count);
