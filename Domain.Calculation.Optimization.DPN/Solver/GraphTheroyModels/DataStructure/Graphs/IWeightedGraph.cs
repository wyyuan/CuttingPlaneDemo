...
namespace DataStructures.Graphs
{
    ...
    public interface IWeightedGraph<T> where T : IComparable<T>
    {
        ...
        /// </summary>
        bool AddEdge(T source, T destination, decimal weight);

        /// <summary>
        /// Updates the edge weight from source to destination.
        /// </summary>
        bool UpdateEdgeWeight(T source, T destination, decimal weight);
        ...
        /// </summary>
        decimal GetEdgeWeight(T source, T destination);

        /// <summary>
        /// Returns the neighbours of a vertex as a dictionary of nodes-to-weights.
        /// </summary>
        System.Collections.Generic.Dictionary<T, decimal> NeighboursMap(T vertex);
    }
}
